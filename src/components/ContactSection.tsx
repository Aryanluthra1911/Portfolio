...
const ContactSection = () => {
  ...
  const copyEmail = () => {
    navigator.clipboard.writeText("aryanluthra1911@gmail.com");
    setCopied(true);
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-4 p-4 border border-foreground/10 bg-white/50 hover:border-black transition-colors duration-300">
              ...
              <div>
                ...
                <p className="font-mono text-sm">+91 7048997027</p>
              </div>
            </div>
          </div>
          <div>
            ...
            <div className="flex gap-4">
              {[
                { Icon: Github, href: "https://github.com/Aryanluthra1911" },
                { Icon: Linkedin, href: "https://www.linkedin.com/in/aryanluthra1911/" },
                {Icon: Mail, href: "mailto:aryanluthra1911@gmail.com"}
              ].map(({ Icon, href }, i) => (
                <a
                  key={i}
                  href={href}
